...
const services = [
    ...
    { id: nextId++, name: 'Еще одна замена стекла', price: 21000, content: 'Качественная замена от лучших заменителей, знаменитых занимательных заменщиков-менял'},
    { id: nextId++, name: 'Еще одна замена дисплея', price: 25000, content: 'Качественная замена от лучших заменителей, знаменитых занимательных заменщиков-менял'},
    { id: nextId++, name: 'Еще одна замена аккумулятора', price: 4000, content: 'Качественная замена от лучших заменителей, знаменитых занимательных заменщиков-менял'},
    { id: nextId++, name: 'Еще одна замена микрофона', price: 2500, content: 'Качественная замена от лучших заменителей, знаменитых занимательных заменщиков-менял'},
    { id: nextId++, name: 'Еще одна замена стекла', price: 21000, content: 'Качественная замена от лучших заменителей, знаменитых занимательных заменщиков-менял'},
    { id: nextId++, name: 'Еще одна замена дисплея', price: 25000, content: 'Качественная замена от лучших заменителей, знаменитых занимательных заменщиков-менял'},
    { id: nextId++, name: 'Еще одна замена аккумулятора', price: 4000, content: 'Качественная замена от лучших заменителей, знаменитых занимательных заменщиков-менял'},
    { id: nextId++, name: 'Еще одна замена микрофона', price: 2500, content: 'Качественная замена от лучших заменителей, знаменитых занимательных заменщиков-менял'},
